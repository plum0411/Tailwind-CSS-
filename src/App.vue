...
<template>
  <main>
    ...
    <br>
    2. <br>
    〈div〉<div class="bg-green-200 text-red-500 w-20 font-bold text-center">text</div>
    〈button〉<br><button class="bg-green-200 text-red-500 px-6 font-bold">text</button><br><br>
